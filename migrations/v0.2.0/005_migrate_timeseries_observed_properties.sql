-- UK AQ v0.2.0 additive TEST migration: direct observed-property links.
...
-- observed_property_id remains nullable during the additive TEST phase.
-- File 009 lists all unmapped timeseries before the canonical NOT NULL rule
-- and removal of phenomenon_id are considered.
