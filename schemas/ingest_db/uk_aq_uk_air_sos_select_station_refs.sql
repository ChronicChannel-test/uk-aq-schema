-- Focused apply file for the UK-AIR SOS station selector helper.
-- Keeps runtime selector logic aligned with canonical schema DDL.

drop function if exists uk_aq_core.uk_air_sos_select_station_refs(integer, integer);
