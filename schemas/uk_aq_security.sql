...
begin
  for t in
    select unnest(ARRAY['uk_air_sos_site_register','laqn_site_register','uk_air_sos_station_refs','breathelondon_timeseries_checkpoints','erg_laqn_station_checkpoints','uk_air_sos_timeseries_checkpoints','openaq_station_checkpoints','error_logs']::text[])
  loop
