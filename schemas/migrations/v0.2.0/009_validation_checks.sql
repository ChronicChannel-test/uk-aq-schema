-- UK AQ v0.2.0 phase 1 validation checks.
-- Read-only. This is the final validation in the default additive sequence.
...
-- Expected during phase 1: observations still has connector_id and its legacy
-- primary key. The final replacement is deferred to the 900-series.
select
  c.column_name,
  c.data_type,
  c.is_nullable
